...
export default function ResellNFT() {
  ...
  async function listNFTForSale() {
    if (!price) {
      ...
      marketPlaceContract.methods.resellNft(EncodedNft.networks[`${networkId}` as keyof typeof EncodedNft.networks]['address'], id, Web3.utils.toWei(formInput.price, "ether"))
